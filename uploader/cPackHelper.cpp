...
void putInt(FILE *fout, int i)
{
	fwrite(&i, sizeof(int), 1, fout);
}

std::string getStr(FILE *fin)
{
	int n = getInt(fin);
...
void putStr(FILE *fout, const std::string& str)
{
...
int cPackHelper::deleteFolder(const std::string &refcstrRootDirectory, bool bDeleteSubdirectories /*= true*/)
{
...
int cPackHelper::deleteFile(const std::string& file)
{
...
std::string cPackHelper::getFullPath(const std::string& file)
{
